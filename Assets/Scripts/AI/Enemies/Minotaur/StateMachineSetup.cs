...
using SwampAttack.AI.Enemies.Minotaur.Attacks;
using SwampAttack.AI.Enemies.Minotaur.States;
using UnityEngine;
...
namespace SwampAttack.AI.Enemies.Minotaur
{
    public sealed class StateMachineSetup : IStateMachineSetup
    {
        ...
        public SM.StateMachine BuildStateMachine()
        {
            var stateMachine = new SM.StateMachine();
